...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="index.html" class="nav-item nav-link active">Booking</a>
                            <form action="" style="padding: 13px 10px">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="d-flex w-25">
            ...
            <a class="navbar-brand text-decoration-none text-white my-auto" href="#">
                <img src="{{ asset('logo_hd.png') }}" height="50" class="d-inline-block align-top" alt="">
                
            </a>
            <a class="navbar-brand text-decoration-none text-white my-auto logo-text" href="#">
                Wardrobe Racing MX
            </a>
        </div>
        ...
        <div class="navbar-collapse collapse justify-content-center" id="collapsingNavbar">
            ...
            <form class="ml-3 my-auto d-inline w-100">
                <div class="input-group">
                  <input type="text" class="form-control border-right-0" placeholder="Cari Barang"> 
                  <div class="input-group-append">
                    <div class="input-group-append">
            ...
            <ul class="navbar-nav w-50 kanan">
                <li class="nav-item ml-auto active">
                    <a href="" class="btn px-0 nav-link">
                        <i class="fas fa-heart text-primary"></i>
                        <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">0</span>
                    </a>
                </li>
