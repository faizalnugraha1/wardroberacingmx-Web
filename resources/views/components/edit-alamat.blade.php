        ...
        <div class="modal-content">
            ...
            <form class="needs-validation" method="POST" novalidate="" action="{{ route('user.store.alamat') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                      <input type="hidden" name="id" value="{{$alamat->enc_id()}}">
                        <div class="form-group col-6">
                          <label>Provinsi</label>
                          <select id="select_provinsi" class="form-control select2" name="provinsi" data-url="{{ route('prov.list') }}" required>
                            <option selected value="{{$alamat->provinsi_id}}">{{$alamat->provinsi->nama}}</option>
                          </select>
                        ...
                        <div class="form-group col-6">
                          ...
                          <select id="select_kota" class="form-control select2" name="kota" required data-placeholder="Pilih Kota/Kabupaten" data-hide-search="true" data-url="{{ route('kota.list') }}">
                            <option selected value="{{$alamat->kota_id}}">{{$alamat->kota->nama}}</option>
                          </select>
                          <div class="invalid-feedback">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          ...
                          <select id="select_kecamatan" class="form-control select2" name="kecamatan" required data-placeholder="Pilih Kecamatan" data-hide-search="true" data-url="{{ route('kecamatan.list') }}">
                            <option selected value="{{$alamat->kecamatan->id}}">{{$alamat->kecamatan->nama}}</option>
                          </select>
                          <div class="invalid-feedback">
                        ...
                        <div class="form-group col-6">
                          ...
                          <input type="text" class="form-control" name="kelurahan" placeholder="(Opsional)" value="{{$alamat->kelurahan}}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          ...
                          <input type="text" class="form-control" name="kode_pos" required value="{{$alamat->kode_pos}}">
                        </div>
                      </div>
    
                      <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <input type="text" class="form-control" name="alamat" required value="{{$alamat->detail}}">
                        <div class="invalid-feedback">
                        </div>
                      </div>
