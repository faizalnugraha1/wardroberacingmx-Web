...
<head>
    ...
    <title>Laporan Booking Bengkel {{ \Carbon\Carbon::parse($tanggal)->translatedFormat('F Y') }}</title>
</head>
...
<body>
        ...
        <table width="100%">
            <tr align="center">
                ...
                <td style="line-height: 0.2cm">
                    ...
                    <h3><i>Laporan Booking Bengkel</i></h3>
    ...
    <table width="100%" border="1" class="table-barang">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="left" style="padding-left: 4px">{{ $d->invoice->booking->booking_id }}</td>
                <td align="left" style="padding-left: 2px">{{ $d->nama }}</td>
                <td align="left" style="padding-left: 4px">{{ $d->invoice->booking->model_motor }}</td>
    ...
    <table width="100%" style="font-size: 18px; font-weight: bold;">
        <tr>
            <td align="right" style="width: 70%"> Total Pemasukan Jasa</td>
